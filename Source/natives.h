...
namespace PLAYER
{
	...
	static Any GET_WANTED_LEVEL_RADIUS(Player player) { return invoke<Any>(0x085DEB493BE80812, player); } // 0x085DEB493BE80812 0x1CF7D7DA
	...
	static void SET_PLAYER_CONTROL(Player player, BOOL toggle, float flags) { invoke<Void>(0x8D32347D6D4C40A2, player, toggle, flags); } // 0x8D32347D6D4C40A2 0xD17AFCD8
	static Cam GET_PLAYER_WANTED_LEVEL(Player player) { return invoke<Cam>(0xE28E54788CE8F12D, player); } // 0xE28E54788CE8F12D 0xBDCDD163
	...
	static void _0xC9A763D8FE87436A(Cam player) { invoke<Void>(0xC9A763D8FE87436A, player); } // 0xC9A763D8FE87436A 0x4136829A
	...
	static void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, BOOL keepVehicle, BOOL keepVelocity, BOOL p7) { invoke<Void>(0xAD15F075A4DA0FDE, player, x, y, z, heading, keepVehicle, keepVelocity, p7); } // 0xAD15F075A4DA0FDE 0xC552E06C
...
namespace VEHICLE
{
	...
	static void _REQUEST_VEHICLE_PHONE_EXPLOSION() { invoke<Void>(0xEF49CF0270307CBE); } // 0xEF49CF0270307CBE 0x65255524
...
namespace CAM
{
	...
	static BOOL CREATE_CAM(char* camName, BOOL unk) { return invoke<BOOL>(0xC3981DCE61D9E13F, camName, unk); } // 0xC3981DCE61D9E13F 0xE9BF2A7D
...
namespace NETWORK
{
	...
	static void _NETWORK_SET_IN_SPECTATOR_MODE_EX(BOOL toggle, Ped playerPed, BOOL p2) { invoke<Void>(0x419594E137637120, toggle, playerPed, p2); } // 0x419594E137637120 0x54058F5F
