...
RGBA Menu::Settings::scroller{ 255, 255, 0, 150 };
...
void Menu::Title(const char * title)
{
	...
	Drawing::Spriter("shopui_title_gr_gunmod", "shopui_title_gr_gunmod", titlebox, 0.1175f, 0.21f, 0.090f, 0, 50, 50, 50, 255);
...
void Menu::SecondTitle(const char * title)
{
